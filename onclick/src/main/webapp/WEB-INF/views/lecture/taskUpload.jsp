...
<html>
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
	            <h2 class="mt-4 ms-3">업로드</h2>
                	<ol class="breadcrumb mb-4 ms-4">
                    	<li class="breadcrumb-item active">과제 업로드</li>
                	</ol>
            	<main>
					...
					<form name="frm">
						<table class="table mx-auto bg-light" style="width:80%">   
							<tbody>
							    ...
							    <tr>
							    	<td colspan="4" style="border-bottom:0"><input type="text" name="taskContents" style="width:100%; height:300px; border:0; solid; black"></td>
							    </tr>
							    <tr>
        ...
        <script type="text/javascript">
			function check() {
			var fm= document.frm;
			if(fm.taskSubject.value == ""){
				alert("제목을 입력하세요");
				fm.taskSubject.focus();
				return false;
			}else if(fm.taskContents.value == ""){
				alert("내용을 입력하세요");
